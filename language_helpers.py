...
def load_dataset(max_length, max_n_examples, tokenize=False, max_vocab_size=2048, data_dir='./torchdata/'):
    print("loading dataset...")
    template = 'training-monolingual.tokenized.shuffled/news.en-{}-of-00100'
    ...
    pbar = tqdm(range(99))
    for i in pbar:
        path = os.path.join(data_dir, template.format(str(i+1).zfill(5)))
        # print(path, data_dir)
